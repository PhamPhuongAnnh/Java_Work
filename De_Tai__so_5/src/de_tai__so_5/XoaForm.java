 ...
 * @author phuon
 */
public class XoaForm extends javax.swing.JFrame {
    ...
    public static void main() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XoaForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
