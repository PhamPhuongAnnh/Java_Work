 ...
 * @author phuon
 */
public class TimKiemPhongForm extends javax.swing.JFrame {

    /**
     * Creates new form TimKiemPhongForm
     */
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Phòng", "Số Tầng", "Loại Phòng", "Giá"
            }
        ));
        ...
        try {
            ...
            for (Phong item : list) {
                if (item.getMaPhong() == txtTimMA.getText()) {
                    ...
                    tableModel.addRow(new Object[]{maPhong, soTang, loai, gia});
                }
            }
    ...
    public static void main() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TimKiemPhongForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TimKiemPhongForm().setVisible(true);
            }
        });
    }
