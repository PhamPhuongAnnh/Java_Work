 ...
 * @author phuon
 */
public class XoaPhongForm extends javax.swing.JFrame {

    /**
     * Creates new form XoaPhongForm
     */
    public XoaPhongForm() {
        initComponents();
    ...
    static File f = new File(PATH_FILE_CSV_Phong);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nhập mã Phòng cần xóa:");
    ...
    public static void main() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XoaPhongForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new XoaPhongForm().setVisible(true);
            }
        });
    }
