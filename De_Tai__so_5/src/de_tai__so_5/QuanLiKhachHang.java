...
public class QuanLiKhachHang {
    ...
    public void suaTenKhachHang(int makhachHang) {
        boolean flag = false;
    ...
    public void suaTuoiKhachHang(int makhachHang) {
        boolean flag = false;
    ...
    public void suaSoCMNDKhachHang(int makhachHang) {
        boolean flag = false;
    ...
    public void suaSoDienThoaiKhachHang(int makhachHang) {
        boolean flag = false;
    ...
    public void suaPhuongTTT(int makhachHang) {
        boolean flag = false;
